...
type ItemsSellerListGetRequest struct {
	Request *topsdk.Request
}

// create new request
func NewItemsSellerListGetRequest() (req *ItemsSellerListGetRequest) {
	request := topsdk.Request{MethodName: "taobao.items.seller.list.get", Params: make(map[string]interface{}, 2)}
...
func (req *ItemsSellerListGetRequest) SetFields(fields string) {
	req.Request.Params["fields"] = fields
}

func (req *ItemsSellerListGetRequest) GetFields() string {
...
func (req *ItemsSellerListGetRequest) SetNumIids(numiids string) {
	req.Request.Params["num_iids"] = numiids
}

func (req *ItemsSellerListGetRequest) GetNumIids() string {
