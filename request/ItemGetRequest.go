...
// create new request
func NewItemGetRequest() (req *ItemGetRequest) {
    request := topsdk.Request{MethodName:"taobao.item.get", Params:make(map[string]interface{}, 2)}
    req = &ItemGetRequest {
        Request: &request,
    }
    return
...
func (req *ItemGetRequest) SetFields(fields string) {
    req.Request.Params["fields"] = fields
}

func (req *ItemGetRequest) GetFields() string {
...
func (req *ItemGetRequest) SetNumIid(numiid uint64) {
    req.Request.Params["num_iid"] = numiid
}

func (req *ItemGetRequest) GetNumIid() uint64 {
