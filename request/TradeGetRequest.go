...
// create new request
func NewTradeGetRequest() (req *TradeGetRequest) {
	request := topsdk.Request{MethodName: "taobao.trade.get", Params: make(map[string]interface{}, 2)}
	req = &TradeGetRequest{
		Request: &request,
	}
	return
...
func (req *TradeGetRequest) SetFields(fields string) {
	req.Request.Params["fields"] = fields
}

func (req *TradeGetRequest) GetFields() string {
...
// 交易编号
func (req *TradeGetRequest) SetTid(tid uint64) {
	req.Request.Params["tid"] = tid
}

func (req *TradeGetRequest) GetTid() uint64 {
